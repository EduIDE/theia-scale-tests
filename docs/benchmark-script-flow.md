...
|---|---|---|---|---|
| 1. Landing + session start | Open landing page, launch `BENCH_TARGET_APP`, wait for IDE shell initialization | `startup-session-ready` | `BENCH_SETUP_TIMEOUT_MS`, default `420000 ms` | No |
...
| Variable | Default |
|---|---|
| `BENCH_SETUP_TIMEOUT_MS` | `420000 ms` |
